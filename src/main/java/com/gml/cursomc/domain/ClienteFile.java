...
@Entity
public class ClienteFile implements Serializable {
    ...
    public ClienteFile(String name, String bucket, String generation, String metageneration, String contentType, String timeCreated, String updated, String storageClass, String size, String md5Hash, String contentEncoding, String contentDisposition, String crc32c, String etag, String downloadTokens, String path, String downloadUrl, Cliente cliente) {
        this.name = name;
        this.bucket = bucket;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("ClienteFile{");
